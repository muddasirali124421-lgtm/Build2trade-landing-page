...
const InviteForm = () => {
  ...
  const EMAILJS_SERVICE_ID = process.env.NEXT_PUBLIC_EMAILJS_INVITE_SERVICE_ID!
  const EMAILJS_TEMPLATE_ID = process.env.NEXT_PUBLIC_EMAILJS_INVITE_TEMPLATE_ID!
