...
const testimonials = [
  {
    ...
    role: 'Director, Thompson Constructions',
    location: 'Sydney, NSW',
    image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&q=80',
    content: 'Build2Trade has completely transformed how we manage our subcontractor network. We\'ve reduced our quote turnaround time by 60% and found reliable tradies we never knew existed.',
    rating: 5,
    type: 'Builder',
  },
  {
    ...
    content: 'As a tradie, finding consistent work was always a challenge. Since joining Build2Trade, I\'ve had a steady stream of quality leads from verified builders. My business has grown 40%.',
    rating: 5,
    type: 'Tradie',
  },
  {
    id: 3,
    name: "David O'Connor",
    role: "Project Manager, O'Connor Devs",
    location: 'Brisbane, QLD',
    image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&q=80',
    content: 'The verification system gives us peace of mind. Every tradie we\'ve hired through Build2Trade has been properly licensed and insured. The rating system helps us make informed decisions quickly.',
    rating: 5,
    type: 'Builder',
  },
]
