    ...
    <header className={`sticky top-0 z-50 transition-all duration-300 bg-white shadow-sm ${scrolled ? 'py-3' : 'py-4'}`}>
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <Link href="/about" className="text-base font-medium text-gray-600 hover:text-brand-blue transition-colors">About Us</Link>
          <Link href="/features" className="text-base font-medium text-gray-600 hover:text-brand-blue transition-colors">Features</Link>
          <Link href="/giveaway" className="text-base font-medium text-gray-600 hover:text-brand-blue transition-colors">Giveaway</Link>
          <Link href="/blogs" className="text-base font-medium text-gray-600 hover:text-brand-blue transition-colors">Blogs</Link>
          <Link href="/contact" className="text-base font-medium text-gray-600 hover:text-brand-blue transition-colors">Contact Us</Link>
          <a
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            ...
            >
              <Link href="/about" onClick={() => setMobileMenuOpen(false)} className="text-lg font-medium text-gray-800">About Us</Link>
              <Link href="/features" onClick={() => setMobileMenuOpen(false)} className="text-lg font-medium text-gray-800">Features</Link>
              <Link href="/giveaway" onClick={() => setMobileMenuOpen(false)} className="text-lg font-medium text-gray-800">Giveaway</Link>
              <Link href="/blogs" onClick={() => setMobileMenuOpen(false)} className="text-lg font-medium text-gray-800">Blogs</Link>
